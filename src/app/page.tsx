...
export default function Home() {
  return (
    <div>
      <Header></Header>
      <section className="flex justify-around   pt-28 z-20  ">
        {/* Left Section */}
      ...
      {/* Dashboard */}
      <section className=" mt-64 flex justify-evenly  max-[1165px]:flex-col max-[1165px]:items-center max-[1165px]:space-y-6 ">
...
/*
-> Send OTP only after registration and later on can do only if mobile number is verified
-> Google Icon in Signup with Google
-> Responsive when sm polish hero form inputs design
-> Input text stays in login when you close it 
